...
de la lista.
Una vez terminado, documenta con el historial de VCS los diferentes estados
por los que ha pasado tu código."""

Asignaturas = ["Informatica","Frances","Filosofia","Etica","Algebra"]

print("Yo estudio " +  str(Asignaturas))   d
